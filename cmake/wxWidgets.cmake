...
if(EXISTS ${wxWidget_LIBS})
  ...
  if(X_WXW_VERSION MATCHES "3.2.*")
    find_package(wxWidgets REQUIRED COMPONENTS core base aui)
    include(${wxWidgets_USE_FILE})
    message(STATUS "[wxWidgets] Using wxWidgets version ${X_WXW_VERSION} with wx-3.2")
    include_directories(${wxWidget_LIBS}/include/wx-3.2)
  else()
    find_package(wxWidgets REQUIRED)
    include(${wxWidgets_USE_FILE})
    message(STATUS "[wxWidgets] Using wxWidgets version ${X_WXW_VERSION}")
    include_directories(${wxWidget_LIBS}/include/wx)
  endif()
