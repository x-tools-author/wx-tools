...
if(MSVC)
  set(lua_lib_file ${WXT_LIBS_DIR}/${WXT_BUILD_FLAG}/lua-${lua_version}/liblua.lib)
elseif(APPLE)
  set(lua_lib_file ${WXT_LIBS_DIR}/${WXT_BUILD_FLAG}/lua-${lua_version}/liblua.a)
else()
  set(lua_lib_file ${WXT_LIBS_DIR}/${WXT_BUILD_FLAG}/lua-${lua_version}/lua.a)
endif()
