...
if(${argPackageType} STREQUAL "deb")
  ...
  execute_process(COMMAND dpkg -b ./ ${argLowerTargetName}-linux-${argVersion}-amd64.deb WORKING_DIRECTORY ${argWorkingDir})
else()
  execute_process(COMMAND ${CMAKE_COMMAND} -E env VERSION=${argVersion} ${argTool} usr/share/applications/${argPacketName}.desktop -always-overwrite -bundle-non-qt-libs -appimage WORKING_DIRECTORY ${argWorkingDir})
endif()
# cmake-format: on
